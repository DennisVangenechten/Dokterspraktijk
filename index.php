...
function handleAddPatient()
{
    try {
        ...
        header("Location: index.php?action=newPatient");
        exit;
    } catch (Exception $e) {
...
function handleUpdatePatient()
{
    try {
        ...
        $_SESSION['error'] = $e->getMessage();
        header("Location: index.php?action=editPatient&patientId=" . $_POST['patientId']);
        exit;
    } catch (Exception $e) {
        handleError("Failed to update patient: " . $e->getMessage());
    }
}
